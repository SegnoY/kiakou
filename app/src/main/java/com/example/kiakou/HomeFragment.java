...
public class HomeFragment extends Fragment {
    ...
    ArrayList<RecyclerViewModele> lstArticle ;
    public HomeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lstArticle.add(new RecyclerViewModele("10000 euro","empreinte digitale",R.id.kiakou));
        lstArticle.add(new RecyclerViewModele("10000 euro","empreinte digitale",R.id.kiakou));
        lstArticle.add(new RecyclerViewModele("10000 euro","empreinte digitale",R.id.kiakou));
        lstArticle.add(new RecyclerViewModele("10000 euro","empreinte digitale",R.id.kiakou));
        lstArticle.add(new RecyclerViewModele("10000 euro","empreinte digitale",R.id.kiakou));
        RecyclerView myrv = (RecyclerView) view.findViewById(R.id.recyclerView);
        RecyclerViewAdapter myAdapter = new RecyclerViewAdapter(getContext(),lstArticle);
